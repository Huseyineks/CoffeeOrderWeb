...
namespace CoffeeOrderWeb.DataAccesLayer.Migrations
{
    ...
    [Migration("20240517190259_changing-relations--new-relations")]
    partial class changingrelationsnewrelations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CoffeeOrderWeb.EntityLayer.Model.PaymentInformation", b =>
                {
                    b.HasOne("CoffeeOrderWeb.EntityLayer.Model.Order", "Order")
                        .WithOne("Payment")
                        .HasForeignKey("CoffeeOrderWeb.EntityLayer.Model.PaymentInformation", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
